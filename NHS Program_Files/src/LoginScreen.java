...
public class LoginScreen extends JFrame 
{
    ...
    public void createScreen() 
    {
        ...
        textPane.setText("NHS form uploading tool:\n.JPEG FILES ONLY! If not .jpeg, search up file converter and convert your file to jpeg!\nIf you are a student, please enter your NAME. Your password will be given to you by NHS team at meeting. Make sure to provide them your name AND your grade.\nAdministrators must enter Admin ID and password to continue.");
        ...
        setTitle("NHS FORM UPLOADER LOGIN");
        pack();
        setSize(500,300);
