        ...
        viewOps.addActionListener(new ActionListener() 
        {
            public void actionPerformed(ActionEvent e) 
            {
                ...
                try 
                {
                    ...
                    String header = "<style>table {table-layout: fixed;}, th, td {border:1px solid black;word-break: break-all;}h1 {text-align: center;}p {text-align: center;}</style><h1 style=\"color:red;font-size:30px;\">NHS Club Volunteer Opportunities Chart</h1><table style=\"width:100%;background-image: url(" + url.toString() + ");\"><thead><tr><th>Opportunity Name</th><th>Opportunity Date</th><th>Opportunity Location</th><th>Other Opportunity Information</th></tr></thead>";
            ...
            public void actionPerformed(ActionEvent e) 
            {
                ...
                if(anyFile)
                {
                    ...
                    try
                    {
                        ...
                        Runtime.getRuntime().exec(new String[] {"Python\\python.exe", "Main.py", "2", username, password, filepath});
                    }
                    catch(Exception l)
                    {
                        MainAPI.ifError(l.toString());
